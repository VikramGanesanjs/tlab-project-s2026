...
python -m classification.run --params-file $BASE_CONFIG_PATH --lr $lr --n-slices $n_slice --early-stopping-metric $stop_metric --seed $seed_used --run-name $run_name --checkpoint-dir $ckpt_dir
